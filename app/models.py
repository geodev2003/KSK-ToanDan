...
class Record(Base):
    ...
    career_id: Mapped[str] = mapped_column(String(16), default="")
    dan_toc: Mapped[str] = mapped_column(String(64), default="")
    ethnic_group_id: Mapped[str] = mapped_column(String(16), default="")
    quoc_tich: Mapped[str] = mapped_column(String(64), default="")
    nationality_id: Mapped[str] = mapped_column(String(16), default="")
    province_id: Mapped[str] = mapped_column(String(16), default="")
